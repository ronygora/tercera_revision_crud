...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="#page-top">Clinica Medica MediUMG</a>
        ...
        <section class="page-section bg-primary text-white mb-0" id="about">
            <div class="container">
                ...
                <h2 class="page-section-heading text-center text-uppercase text-white">Historia</h2>
                <!-- Icon Divider-->
                <div class="divider-custom divider-light">
                    <div class="divider-custom-line"></div>
                    <div class="divider-custom-icon"><i class="fas fa-star"></i></div>
                ...
                <div class="row">
                    <div class="col-lg-4 ml-auto"><p class="lead"><b>Misión:</b>
Somos un hospital general nacional, docente asistencial, de referencia y cobertura nacional, dependencia del Ministerio de Salud Pública y Asistencia Social de Guatemala, responsable de brindar atención integral de salud, con calidez y calidad, mediante la promoción de la salud, prevención de enfermedades, recuperación y rehabilitación de usuarias y usuarios, contando con recurso humano calificado y tecnología moderna para el mejoramiento de la calidad de vida.</p></div>
                    <div class="col-lg-4 mr-auto"><p class="lead"><b>Visión:</b>
Ser el hospital líder a nivel nacional, comprometido a brindar atención especializada e integral de servicios de salud, mediante un sistema certificado de gestión de calidad apoyado con personal calificado, tecnología moderna y pertinente, orientada a satisfacer las necesidades y expectativas de usuarias y usuarios.</p></div>
                </div>
        ...
        <footer class="footer text-center">
            <div class="container">
                <div class="row">
                    ...
                    <!-- Footer Social Icons-->
                    <div class="col-lg-4 mb-5 mb-lg-0">
                        <h4 class="text-uppercase mb-4">Siguenso en nuestras redes sociales</h4>
                    ...
                    <!-- Footer About Text-->
                    <div class="col-lg-4">
                        <h4 class="text-uppercase mb-4">Somos Especialistas en:</h4>
                        <p class="lead mb-0">
                            Consulta General, Rayos X, Pruebas de Sangre, Pruebas de COVID-19
                            <a href="cita.jsp">Agenda tu Cita</a>
                            .
                        </p>
                    </div>
                </div>
